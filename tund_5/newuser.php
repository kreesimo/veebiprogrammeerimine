<?php
  ...
  //kontrollin kuupaevaoigsust:
  if(isset($_POST["birthDay"]) and isset($_POST["birthYear"]) and isset($_POST["birthMonth"])) {
  	if(checkdate(intval($_POST["birthDay"]))){
  ...
  signup($name,$surname,$email,$gender,$birthDate,$password);
